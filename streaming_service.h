...
struct user *UsersList; /*points to the fist user of the USERS LIST*/
struct new_movie *NewMoviesList; /*point to the first new movie of the New Movies List*/


struct movie *categoriesArray[6];/*0 : HORROR , 1 : SCIFI , 2 : DRAMA , 3 : ROMANCE , 4 : DOCUMENTARY , 5 : COMEDY*/
const char *categoryNames[] = {"HORROR", "SCIFI", "DRAMA", "ROMANCE", "DOCUMENTARY", "COMEDY"};
